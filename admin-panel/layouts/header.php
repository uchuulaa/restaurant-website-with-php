<?php
    $app = new App();
    $app->startingSession();
    define("ADMINURL", "http://localhost/stafflounge/admin-panel/");
    define("APP", "http://localhost/stafflounge/");
?>
...
<div id="wrapper">
    <nav class="navbar header-top fixed-top navbar-expand-lg  navbar-dark bg-dark">
      <div class="container">
      <a class="navbar-brand" href="#">Staff Lounge</a>
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        ...
        <ul class="navbar-nav side-nav" >
          <li class="nav-item">
            <a class="nav-link" style="margin-left: 20px;" href="<?php echo APP; ?>">Home Page
            </a>
          </li>
          <li class="nav-item">
